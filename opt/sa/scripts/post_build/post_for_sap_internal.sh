...
f_runStep 150 "/opt/sa/scripts/post_build/sap_dbci_add_local_accounts.sh $SID"

# Add required filesystems
f_runStep 200 "/opt/sa/scripts/post_build/sap_dbci_filesystem_setup.sh $SID"

# Synchronize package levels with subscribed distros
f_runStep 300 "/usr/bin/yum -y distribution-synchronization"

# Install supplementary packages
f_runStep 310 "/opt/sa/scripts/post_build/sap_dbci_supplementary_packages.sh"

# Try to force a puppet run
f_runStep 320 "/opt/sa/scripts/post_build/puppetrun.sh"
...
f_runStep 600 "/opt/sa/scripts/post_build/setup_firewalld.sh SAP"

# Set miscellaneous permissions
f_runStep 800 "/opt/sa/scripts/post_build/sap_dbci_permissions.sh"

# Enable firstrun setup (generate QA, install VMtools etc...)
f_runStep 900 "/opt/sa/scripts/post_build/setup_firstrun.sh"
