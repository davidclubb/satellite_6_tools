...
# Post Clone steps to create Oracle DB Server
...
f_runStep 200 "/opt/sa/scripts/setup_rhss.sh ORACLEDB"

# Synchronize package levels with subscribed distros
f_runStep 300 "/usr/bin/yum -y distribution-synchronization"

# Install supplementary packages
f_runStep 350 "/opt/sa/scripts/cloud_assist/oracle_db_supplementary_packages.sh"
...
f_runStep 500 "/opt/sa/scripts/setup_sysctl.sh ORACLEDB"

# Activate kernel tunings
f_runStep 510 "/sbin/sysctl -p"

# Add local accounts
f_runStep 600 "/opt/sa/scripts/cloud_assist/oracle_db_add_local_accounts.sh"

# Add required filesystems
f_runStep 700 "/opt/sa/scripts/cloud_assist/oracle_db_filesystem_setup.sh"

# Label ASM Disks
f_runStep 710 "/opt/sa/scripts/cloud_assist/oracle_db_asmdisk.sh"

# Set miscellaneous permissions
f_runStep 800 "/opt/sa/scripts/cloud_assist/oracle_db_permissions.sh"

# Install the 11.2G Database

f_runStep 900 "/opt/sa/scripts/cloud_assist/oracle_db_11.2_silent_install.sh"
